...
<main>
  ...
  <div class="container my-5">
    ...
    <div class="row propiedades-filtradas">
      ...
      <?php
      $siguientes_diez = array_slice($propiedades, 10); //Se empieza a contar desde la propiedad numero 10
      foreach ($siguientes_diez as $propiedad) {
  ...
  <div class="container-nav">
    <ul class="navigation-links">
      ...
      <li><a href="#">2</a></li>
      <li><a href="#page-next">Siguiente</a></li>
    </ul>
  </div>
